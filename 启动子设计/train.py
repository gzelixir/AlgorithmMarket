...
class GPT(nn.Module):
    ...
    def from_pretrained(cls, model_type, override_args=None):
        ...
        override_args = override_args or {} # default to empty 
...
min_lr = 6e-5 # minimum learning rate, should be ~= learning_rate/10 per 
# DDP settings
...
external_data = os.path.join(parent_dir, 'data', input_data)
os.system(f"mv -f {external_data} data/tss50/")
os.system(f"python data/tss50/prepare.py --data {input_data}")
...
while True:
    ...
    if iter_num % eval_interval == 0 and master_process:
        ...
        #     })
        mlflow.log_metric(key="quality", value=2 * iter_num, step=iter_num)
...
test_predictions = loaded_model.predict(model_input=df, context="")
print("++++++++++RESULTS++++++++++")
...
# NV_GPU=0 nvidia-docker run -p 127.0.0.1:5001:8080 \
# -e  MLSERVER_INFER_WORKERS=2 \
# cloud.zelixir.comlflow-202310181047155821d1cfa:132-f47afda5b7f64400b5d7c68fb73e6930 
