...
@R.register("tasks.KcatPrediction")
class KcatPrediction(tasks.Task, core.Configurable):
    """
    Protein/molecule kcat prediction task.
    ...
    def evaluate(self, pred, target):
        ...
        for _metric in self.metric:
            if _metric == "mae" or _metric =="MAE":
                ...
                #     score.append(_score)
                # score = torch.stack(score)
                score = metrics.r2(pred.view(-1), target.view(-1))
