...
@R.register("tasks.PromoterPrediction")
class PromoterPrediction(tasks.Task, core.Configurable):
    """
    DNA promoter prediction task.
    ...
    def __init__(self, model, task=(), criterion="bce", metric=("acc", "bce"), num_mlp_layer=1,
                 ...
                 verbose=0):
        super(PromoterPrediction, self).__init__()
        self.model = model
        self.task = task
