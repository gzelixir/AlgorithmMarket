...
@R.register("tasks.ProteinSolubilityPrediction")
class ProteinSolubilityPrediction(tasks.Task, core.Configurable):
    """
    Protein solubility prediction task.
    ...
    def __init__(self, model, task=(), criterion="bce", metric=("acc", "bce"), num_mlp_layer=1,
                 ...
                 verbose=0):
        super(ProteinSolubilityPrediction, self).__init__()
        self.model = model
        self.task = task
