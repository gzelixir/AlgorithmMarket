...
@R.register("tasks.TFBSPrediction")
class TFBSPrediction(tasks.Task, core.Configurable):
    """
    transcription_factor_binding_sites prediction task.
    ...
    def __init__(self, model, task=(), criterion="bce", metric=("acc", "bce"), num_mlp_layer=1,
                 ...
                 verbose=0):
        super(TFBSPrediction, self).__init__()
        self.model = model
        self.task = task
