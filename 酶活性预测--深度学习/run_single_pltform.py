...
if __name__ == "__main__":
    args = parse_args()
    if args.task == 'enhancer_activity':
        args.config = './config/enhancer_activity/deepstarr.yaml'
    elif args.task == 'protein_solubility':
        args.config = './config/soluprot/proteincnn1d.yaml'
    else:
    ...
    cfg.dataset.path = f'{current_dir}/{cfg.dataset.path}'
