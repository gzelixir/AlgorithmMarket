...
from zbiosynth import core, utils
from zbiosynth.data import Dictionary
from zbiosynth.utils import pretty
...
class Graph(core._MetaContainer):
    ...
    To batch graphs with variadic sizes, use :meth:`data.Graph.pack <zbiosynth.data.Graph.pack>`.
